            ...
            <div className="space-y-4">
              <div className="flex items-start group">
                ...
                <p className="text-gray-700 group-hover:text-rose-600 transition-colors duration-300 text-sm">
                  Qalhat<br />
                  Near Qalhat Manicipility - Next to Balamand University<br />
                  Koura, Lebanon
                </p>
              </div>
        ...
        <div className="border-t border-rose-200 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm mb-4 md:mb-0">
              &copy;{new Date().getFullYear()} TechNerds by Bassem Kreidly. All rights reserved.
            </p>
