...
function Users() {
  ...
  const columns = [
    // { field: "_id", headerName: "ID", width: 90 }, // From image_4b2341.png
    // {
    //   field: "name",
    //   headerName: "Name",
    //   width: 250,
    //   renderCell: (params) => (
    //     // UI logic from image_40e3bb.png
    ...
    { field: "role", headerName: "Role", width: 100 },
    {
      ...
      width: 100,
      renderCell: (params) => (
        // Link and Button logic from image_40dc5a.png
    ...
    },
    {
      ...
      width: 150,
      renderCell: (params) => (
        // Trash icon logic from image_4b2341.png
