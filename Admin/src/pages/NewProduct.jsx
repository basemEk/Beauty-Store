  ...
  return (
    <div className="p-5">
      ...
      <div className="mt-5 bg-white p-5 shadow-lg rounded-lg">
        <form className="flex flex-col md:flex-row rounded-lg" action="">
          {/* LEFT */}
          <div className="flex-1 space-y-5">
            ...
            <div className="flex-1 bg-white p-5">
              ...
              <div>
              <p className="text-gray-500 text-[12px]">Uploading is 0%</p>
            </div>
            </div>
          ...
          <div className="flex-1 space-y-5 ml-5">
            ...
            <div>
              ...
              <select
                name=""
                id=""
                className="border-2 border-[#444] p-2 mb-4 sm:mb-0 sm:mr-4"
              >
